        ...
        <form className="my-3 grid gap-2" onSubmit={handleSubmit}>
          <div className="grid gap-1">
            ...
            <input
              ...
              className="bg-blue-50 p-2 border border-blue-100 focus-within:border-[color:var(--primary-200)] outline-none rounded"
            />
          </div>
              ...
              <label htmlFor="uploadCategoryImage">
                <div
                  className={`${
                    !data.name
                      ? "bg-gray-400"
                      : "border-[color:var(--primary-200)] hover:bg-[color:var(--primary-100)]"} 
          ...
          <button
            className={` ${
              data.name && data.image
                ...
                : "bg-gray-300"
            } px-5 py-2 font-semibold rounded cursor-pointer`}
          >
            Update Category
          </button>
        </form>
